...
class ContactosController extends BaseController
{
    ...
    public function loginAction()
    {
        ...
        if (isset($_POST['submit'])) {
            if ($claseUsuario->getMensaje() != 'El usuario No se encuentra en la base de datos o tiene la cuenta sin activar. Revisa tu email y activa tu cuenta.') {
    ...
    public function registrarAction()
    {
        ...
        $categorias_profesional = $_POST['categorias_profesional'] ?? null;
    ...
    public function perfilAction()
    {
        ...
        if (isset($_POST['actualizar_perfil'])) {
            ...
            $ruta_destino = 'img/' . $foto_perfil['name'];
            move_uploaded_file($foto_perfil['tmp_name'], $ruta_destino);

            $claseUsuario->actualizarUsuario($nombre, $apellidos, $categorias_profesional, $resumen_perfil, $ruta_destino, $usuario['id']); 
